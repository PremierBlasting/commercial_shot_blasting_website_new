  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <LocalBusinessSchema
        ...
        city="Sheffield"
        region="Yorkshire"
        description="Professional shot blasting services in Sheffield and Yorkshire"
        url="https://shotblast-lwspuaik.manus.space/service-areas/sheffield"
      />
      ...
      <section className="py-4 bg-gray-50 border-b border-gray-200">
        <div className="container">
          <Breadcrumb items={[
            ...
            { label: "Sheffield", href: "/service-areas/sheffield", isCurrentPage: true }
          ]} />
        </div>
      </section>
        ...
        <div className="container">
          <div className="mb-6">
            <h2 className="text-2xl md:text-3xl font-bold text-[#2C2C2C] mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>
              Sheffield Project Transformation
            </h2>
      ...
      {/* About Sheffield Service Area */}
      <section className="py-16 bg-[#F5F1E8]">
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#2C2C2C] mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
                Your Local Shot Blasting Experts in Sheffield
              </h2>
              <p className="text-gray-700 mb-4">
                Commercial Shot Blasting has been serving Sheffield businesses for years, providing professional surface preparation services to the region's leading steel manufacturers, engineering companies, and industrial facilities.
              </p>
              <p className="text-gray-700 mb-6">
                Sheffield's world-renowned steel industry relies on our expertise for precision surface preparation. Whether you need rust removal, paint stripping, or concrete surface profiling, we have the equipment and experience to deliver exceptional results.
              </p>
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#2C5F7F] flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Competitive pricing for Sheffield businesses</span>
                </li>
              </ul>
            </div>
            <div className="relative">
              <img
                src="/images/premier/commercial-shot-blasting-warehouse-bars-after-treatment.webp"
              ...
              <div className="absolute bottom-0 right-0 bg-[#2C5F7F] text-white p-6 rounded-lg shadow-lg max-w-xs">
                <p className="font-semibold mb-2">Serving Sheffield Since</p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide a complete range of shot blasting and surface preparation services tailored to Sheffield's steel and engineering industries.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Complete rust removal solutions for manufacturing, engineering, and infrastructure projects across Sheffield.",
                icon: Award
              },
              {
              ...
              {
                title: "Steel Fabrication Support",
                description: "Specialized blasting services for steel fabrication, welding preparation, and component finishing.",
                icon: Award
              },
              {
      ...
      {/* Industries Served in Sheffield */}
      <section className="py-16 bg-[#F5F1E8]">
        <div className="container">
            ...
            {[
              {
                ...
                items: ["Structural steel preparation", "Steel fabrication support", "Coating preparation", "Quality control finishing"]
              },
              {
                title: "Engineering & Tooling",
                items: ["Tool and die preparation", "Component finishing", "Equipment restoration", "Precision cleaning"]
              },
              {
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <h2 className="text-3xl md:text-4xl font-bold text-[#2C2C2C] mb-12 text-center" style={{ fontFamily: "'Playfair Display', serif" }}>
            Why Sheffield Businesses Choose Us
          </h2>
            ...
            {[
              {
                ...
                description: "We understand Sheffield's industrial landscape and the specific needs of local businesses."
              },
              {
                icon: Zap,
              ...
              },
              {
                ...
                description: "Professional quality at competitive rates tailored to Sheffield market conditions."
              }
            ].map((item, idx) => {
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: "Yes, we provide comprehensive coverage throughout Sheffield and the surrounding Yorkshire region. We handle projects of all sizes from small components to large industrial equipment."
              },
              {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#2C5F7F] mb-4">
              Our Shot Blasting Services in Sheffield
            </h2>
            <p className="text-lg text-gray-600">
              We provide professional shot blasting services throughout Sheffield and the surrounding region. The map shows our primary service area with a 25-mile radius.
            </p>
          </div>
      ...
      <section className="py-16 bg-[#2C5F7F] text-white">
        <div className="container text-center">
          ...
          <p className="text-white/90 mb-8 max-w-2xl mx-auto">
            Get professional shot blasting services in Sheffield. Contact us for a free quote and discover why local businesses trust Commercial Shot Blasting.
          </p>
