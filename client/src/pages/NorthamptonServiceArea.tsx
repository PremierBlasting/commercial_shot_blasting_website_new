...
export default function NorthamptonServiceArea() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-white/90 mb-8">
              Commercial Shot Blasting provides professional surface preparation and rust removal services throughout Northampton and the East Midlands. Serving local manufacturers, logistics facilities, and industrial businesses with precision blasting solutions.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#2C2C2C] mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
                Your Local Shot Blasting Experts in Northampton
              </h2>
              <p className="text-gray-700 mb-4">
                Commercial Shot Blasting has been serving Northampton businesses for years, providing professional surface preparation services to the region's leading manufacturers, automotive restoration specialists, and industrial facilities.
              </p>
              <p className="text-gray-700 mb-6">
                Northampton's thriving manufacturing and automotive sectors rely on our expertise for precision surface preparation. Whether you need rust removal, paint stripping, or concrete surface profiling, we have the equipment and experience to deliver exceptional results.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#2C5F7F] flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Same-day quotes for Northampton area projects</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#2C5F7F] flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#2C5F7F] flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Competitive pricing for Northampton businesses</span>
                </li>
              </ul>
            </div>
            <div className="relative">
              ...
              <div className="absolute bottom-0 right-0 bg-[#2C5F7F] text-white p-6 rounded-lg shadow-lg max-w-xs">
                <p className="font-semibold mb-2">Serving Northampton Since</p>
      ...
      {/* Services for Northampton */}
      <section className="py-16 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#2C2C2C] mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
              Services Available in Northampton
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide a complete range of shot blasting and surface preparation services tailored to Northampton's diverse industries.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Complete rust removal solutions for automotive, manufacturing, and infrastructure projects across Northampton.",
                icon: Award
              },
              {
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <h2 className="text-3xl md:text-4xl font-bold text-[#2C2C2C] mb-12 text-center" style={{ fontFamily: "'Playfair Display', serif" }}>
            Why Northampton Businesses Choose Us
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
              ...
              {[
                {
                  ...
                  description: "We understand Northampton's industrial landscape and the specific needs of local businesses."
                },
                {
            ...
            <div className="bg-[#2C5F7F] text-white p-8 rounded-lg">
              ...
              <p className="mb-6">
                Contact us today for a free, no-obligation quote on your Northampton shot blasting project.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">Northampton & East Midlands</p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-[#F5F1E8]">
        <div className="container">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            {[
              {
                q: "How quickly can you provide a quote for Northampton projects?",
                a: "We typically provide same-day quotes for Northampton area projects. Contact us with your project details and we'll respond within hours."
              },
              {
                q: "Do you service all areas of Northampton?",
                a: "Yes, we provide comprehensive coverage throughout Northampton and the surrounding East Midlands region. We handle projects of all sizes from small components to large industrial equipment."
              },
              {
      ...
      <section className="py-16 bg-gradient-to-r from-[#2C5F7F] to-[#1a3d52] text-white">
        <div className="container text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Get professional shot blasting services in Northampton. Contact us for a free quote and discover why local businesses trust Commercial Shot Blasting.
          </p>
        ...
        <div className="container">
          ...
          <div className="border-t border-white/10 pt-8">
            <p className="text-center text-white/70 text-sm">
              © 2024 Commercial Shot Blasting. All rights reserved. | Serving Northampton and the East Midlands
            </p>
          </div>
        </div>
      </footer>
