    ...
    <div className="min-h-screen flex flex-col" style={{ fontFamily: "'Open Sans', sans-serif" }}>
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: "Wolverhamton", url: "https://commercialshotblasting.co.uk/service-areas/wolverhamton" }
        ]}
      />
      <LocalBusinessSchema 
        name="Wolverhamton"
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img src="https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=600" alt="Commercial shot blasting services in Wolverhamton - professional surface preparation" className="rounded-lg shadow-xl"  loading="lazy" />
