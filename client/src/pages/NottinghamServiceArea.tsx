  ...
  return (
    <div className="border-b border-gray-200 py-4">
      ...
      <LocalBusinessSchema 
        ...
        city="Nottingham"
        region="England"
        description="Professional shot blasting services in Nottingham. Expert surface preparation for industrial and commercial projects."
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img src="https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=600" alt="Commercial shot blasting services in Nottingham - professional surface preparation" className="rounded-lg shadow-xl"  loading="lazy" />
