        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-white/90 mb-8">
              Commercial Shot Blasting provides professional surface preparation and rust removal services throughout Peterborough and the East of England. Serving local engineering firms, agricultural businesses, and industrial facilities with precision blasting solutions.
            </p>
