...
export default function ChesterfieldServiceArea() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-4 bg-gray-50 border-b border-gray-200">
        <div className="container">
          <Breadcrumb items={[
            ...
            { label: "Chesterfield", href: "/service-areas/chesterfield", isCurrentPage: true }
          ]} />
        </div>
      </section>
        ...
        <div className="container">
          <div className="mb-6">
            <h2 className="text-2xl md:text-3xl font-bold text-[#2C2C2C] mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>
              Chesterfield Project Transformation
            </h2>
      ...
      {/* About Chesterfield Service Area */}
      <section className="py-16 bg-[#F5F1E8]">
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#2C2C2C] mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
                Your Local Shot Blasting Experts in Chesterfield
              </h2>
              <p className="text-gray-700 mb-4">
                Commercial Shot Blasting has been serving Chesterfield businesses for years, providing professional surface preparation services to the region's leading manufacturers, automotive restoration specialists, and industrial facilities.
              </p>
              <p className="text-gray-700 mb-6">
                Chesterfield's thriving manufacturing and automotive sectors rely on our expertise for precision surface preparation. Whether you need rust removal, paint stripping, or concrete surface profiling, we have the equipment and experience to deliver exceptional results.
              </p>
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#2C5F7F] flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Competitive pricing for Chesterfield businesses</span>
                </li>
              </ul>
            </div>
            <div className="relative">
              <img
                src="/images/premier/commercial-shot-blasting-steel-container-after.webp"
              ...
              <div className="absolute bottom-0 right-0 bg-[#2C5F7F] text-white p-6 rounded-lg shadow-lg max-w-xs">
                <p className="font-semibold mb-2">Serving Chesterfield Since</p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide a complete range of shot blasting and surface preparation services tailored to Chesterfield's diverse industries.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Complete rust removal solutions for automotive, manufacturing, and infrastructure projects across Chesterfield.",
                icon: Award
              },
              {
      ...
      <section className="py-16 bg-white">
        <div className="container">
          <h2 className="text-3xl md:text-4xl font-bold text-[#2C2C2C] mb-12 text-center" style={{ fontFamily: "'Playfair Display', serif" }}>
            Why Chesterfield Businesses Choose Us
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
              ...
              {[
                {
                  ...
                  description: "We understand Chesterfield's industrial landscape and the specific needs of local businesses."
                },
                {
                ...
                },
                {
                  ...
                  description: "Professional quality at competitive rates tailored to Chesterfield market conditions."
                },
                {
            ...
            <div className="bg-[#2C5F7F] text-white p-8 rounded-lg">
              ...
              <p className="mb-6">
                Contact us today for a free, no-obligation quote on your Chesterfield shot blasting project.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">Chesterfield & East Midlands</p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            {[
              ...
              },
              {
                ...
                a: "Yes, we provide comprehensive coverage throughout Chesterfield and the surrounding East Midlands region. We handle projects of all sizes from small components to large industrial equipment."
              },
              {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#2C5F7F] mb-4">
              Our Shot Blasting Services in Chesterfield
            </h2>
            <p className="text-lg text-gray-600">
              We provide professional shot blasting services throughout Chesterfield and the surrounding region. The map shows our primary service area with a 25-mile radius.
            </p>
          </div>
          <LocationMap locationName="Chesterfield" />
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-[#2C5F7F] to-[#1a3d52] text-white">
        <div className="container text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Get professional shot blasting services in Chesterfield. Contact us for a free quote and discover why local businesses trust Commercial Shot Blasting.
          </p>
        ...
        <div className="container">
          ...
          <div className="border-t border-white/10 pt-8">
            <p className="text-center text-white/70 text-sm">
              © 2024 Commercial Shot Blasting. All rights reserved. | Serving Chesterfield and the East Midlands
            </p>
          </div>
        </div>
      </footer>
