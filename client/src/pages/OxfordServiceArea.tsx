        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-white/90 mb-8">
              Commercial Shot Blasting provides professional surface preparation and rust removal services throughout Oxford and the South East. Serving local technology companies, research facilities, and heritage restoration projects with precision blasting solutions.
            </p>
