    ...
    <div className="min-h-screen bg-white">
      ...
      <BreadcrumbSchema 
        items={[
          ...
          { name: "Manchester", url: "https://commercialshotblasting.co.uk/service-areas/manchester" }
        ]}
      />
      ...
      <section className="py-4 bg-gray-50 border-b border-gray-200">
        <div className="container">
          <Breadcrumb items={[
            ...
            { label: "Manchester", href: "/service-areas/manchester", isCurrentPage: true }
          ]} />
        </div>
      </section>
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
              Shot Blasting Services in Manchester
            </h1>
            <p className="text-lg text-white/90 mb-8">
              Commercial Shot Blasting provides professional surface preparation and rust removal services throughout Manchester and the North West. Serving local manufacturers, engineering firms, and industrial facilities with precision blasting solutions.
            </p>
        ...
        <div className="container">
          <div className="mb-6">
            <h2 className="text-2xl md:text-3xl font-bold text-[#2C2C2C] mb-2" style={{ fontFamily: "'Playfair Display', serif" }}>
              Manchester Project Transformation
            </h2>
      ...
      {/* About Manchester Service Area */}
      <section className="py-16 bg-[#F5F1E8]">
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#2C2C2C] mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
                Your Local Shot Blasting Experts in Manchester
              </h2>
              <p className="text-gray-700 mb-4">
                Commercial Shot Blasting has been serving Manchester businesses for years, providing professional surface preparation services to the region's leading manufacturers, engineering companies, and industrial facilities.
              </p>
              <p className="text-gray-700 mb-6">
                Manchester's diverse industrial base relies on our expertise for precision surface preparation. Whether you need rust removal, paint stripping, or concrete surface profiling, we have the equipment and experience to deliver exceptional results.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#2C5F7F] flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Same-day quotes for Manchester area projects</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#2C5F7F] flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-[#2C5F7F] flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Competitive pricing for Manchester businesses</span>
                </li>
              </ul>
            </div>
            <div className="relative">
              <img
                src="/images/premier/commercial-shot-blasting-gate-after-treatment.webp"
              ...
              <div className="absolute bottom-0 right-0 bg-[#2C5F7F] text-white p-6 rounded-lg shadow-lg max-w-xs">
                <p className="font-semibold mb-2">Serving Manchester Since</p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide a complete range of shot blasting and surface preparation services tailored to Manchester's diverse industries.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Complete rust removal solutions for manufacturing, engineering, and infrastructure projects across Manchester.",
                icon: Award
              },
              {
              ...
              },
              {
                ...
                description: "Specialized blasting services for building restoration, heritage projects, and structural steel preparation.",
                icon: CheckCircle
              }
            ].map((service, idx) => {
      ...
      {/* Industries Served in Manchester */}
      <section className="py-16 bg-[#F5F1E8]">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              {
                title: "Construction & Heritage",
                items: ["Structural steel preparation", "Building restoration", "Heritage project support", "Concrete profiling"]
              },
              {
                title: "Industrial & Heavy Equipment",
                items: ["Machinery restoration", "Equipment cleaning", "Industrial maintenance", "Component preparation"]
              },
              {
                title: "Infrastructure & Utilities",
                items: ["Bridge maintenance", "Pipeline preparation", "Utility equipment cleaning", "Infrastructure support"]
              }
            ].map((industry, idx) => (
            ...
            {[
              {
                ...
                description: "We understand Manchester's industrial landscape and the specific needs of local businesses."
              },
              {
                icon: Zap,
              ...
              },
              {
                ...
                description: "Professional quality at competitive rates tailored to Manchester market conditions."
              }
            ].map((item, idx) => {
      ...
      <section className="py-16 bg-[#F5F1E8]">
        <div className="container max-w-3xl">
          ...
          <div className="space-y-6">
            {[
              {
                q: "How quickly can you provide a quote for Manchester projects?",
                a: "We typically provide same-day quotes for Manchester area projects. Contact us with your project details and we'll respond within hours."
              },
              {
                q: "Do you service all areas of Manchester?",
                a: "Yes, we provide comprehensive coverage throughout Manchester and the surrounding North West region. We handle projects of all sizes from small components to large industrial equipment."
              },
              {
      ...
      <section className="py-16 bg-[#2C5F7F] text-white">
        <div className="container text-center">
          ...
          <p className="text-white/90 mb-8 max-w-2xl mx-auto">
            Get professional shot blasting services in Manchester. Contact us for a free quote and discover why local businesses trust Commercial Shot Blasting.
          </p>
